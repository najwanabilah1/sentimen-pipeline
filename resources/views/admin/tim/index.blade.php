...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.tim.create') }}" class="bg-gray-900 text-white px-4 py-2 rounded-xl text-sm hover:bg-gray-800 transition">Tambah Anggota</a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="p-6">
                ...
                <div class="flex justify-between items-center pt-4 border-t border-gray-50">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('admin.tim.edit', $m) }}" class="text-gray-400 hover:text-blue-600 transition"><i class="fa-solid fa-pencil text-xs"></i></a>
        ...
        <div class="col-span-3 bg-white p-12 rounded-2xl border border-gray-100 shadow-sm text-center">
            <p class="text-gray-500">Belum ada anggota tim. <a href="{{ route('admin.tim.create') }}" class="text-red-600 font-bold">Tambah anggota</a></p>
        </div>
        @endforelse
    </div>
</div>
